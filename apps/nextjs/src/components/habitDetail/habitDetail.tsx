...
import CompletionsWithSuccessRate from './completionsWithSuccessRate'
...
const HabitDetail = ({ habitId }: Props) => {
	...
	return (
		<div className="flex flex-1 flex-col gap-6 lg:grid lg:grid-cols-2 lg:gap-6 lg:px-4 2xl:grid-cols-4 2xl:grid-rows-[200px_auto]">
			...
			<Button
				variant="link"
				className="text-content row-start-6 lg:col-span-2 2xl:col-span-4 2xl:row-start-4"
			>
				<Link
