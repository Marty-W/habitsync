...
const Backlink = () => {
	return (
		<a
			...
			target="_blank"
			rel="noopener noreferrer"
			className="dark:bg-trueGray-900 dark:border-trueGray-700 dark:text-trueGray-300 absolute bottom-5 left-5 flex place-items-center space-x-2 rounded border border-gray-300 bg-white px-3 py-1 text-sm font-semibold text-gray-900 shadow-sm"
		>
			<svg
				width="20"
				height="20"
